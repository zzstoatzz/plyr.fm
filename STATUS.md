...
**recent context**: these fixes followed the major playlist feature launch (PR #499, Dec 6-7). See `.status_history/2025-12.md` for complete details on:
- full CRUD playlists with ATProto sync
- library hub with unified collections interface
- scope upgrade OAuth flow for teal.fm integration
- settings consolidation (settings vs portal separation)
- mobile artwork upload fixes for iOS HEIC format
- sensitive image moderation system
...
- copyright moderation system with ATProto labeler (PRs #382-395)
- developer tokens with independent OAuth grants (PR #367)
- platform stats and media session integration (PRs #359-379)
...
- ✅ sensitive image moderation with user opt-in

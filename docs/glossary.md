...
a bundle of OAuth scopes under a human-readable name. instead of seeing individual scope strings, users see something like "plyr.fm Music Library". plyr.fm defines `fm.plyr.authFullApp` to cover all required permissions.

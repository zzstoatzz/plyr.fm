...
### `upload_track` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L910)
...
### `upload_progress` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L1095)
...
### `AudioInfo` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L107)


result of audio validation phase.


### `StorageResult` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L116)


result of audio storage phase.


### `UploadPhaseError` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L127)


raised when an upload phase fails with a user-facing message.


### `TranscodeInfo` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L227)


result of transcoding an audio file.


### `PdsBlobResult` [source](https://github.com/zzstoatzz/plyr.fm/blob/main/backend/src/backend/api/tracks/uploads.py#L238)

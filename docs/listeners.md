...
you have a handle. you like music. let's go.
...
2. **find a track** — browse the feed or hit `Cmd+K` to search by name or mood
...
- **mood search** — search by vibe, not just keywords (`Cmd+K` → "rainy afternoon jazz")

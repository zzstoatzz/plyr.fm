...
## August 24 – 27 detail (archived 2026-09-02)
...
**the CF Pages lesson from the same window**: a deployment can report
"Active" with a failed Functions step and no worker, and wrangler 3.x cannot
parse import attributes — `ssr.noExternal` is what keeps `@atproto/api`
bundled (#1949, #1950).

...
- `AGENTS.md` — project rules, stack, structure, conventions
...
cd plyr.fm
uv sync --directory backend && cd frontend && bun install && cd ..
...
with the user’s authorization to publish, open a PR from your fork to `zzstoatzz/plyr.fm:main`. describe what changed and why.
